const dataHollywoodController=function(req,res){
    res.send(
    [
        {
...
const data1HollywoodController=function(req,res){
    res.send(
   [
    {
...
module.exports={dataHollywoodController,data1HollywoodController}